...
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/winter"
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/winter/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/winter/wall.png"
theme.lain_icons                                = os.getenv("HOME") .. "/.config/awesome/themes/winter"
